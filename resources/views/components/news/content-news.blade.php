 ...
 <section id="berita" class="max-w-7xl mx-auto md:px-6 py-12">
     <h2 class="text-2xl font-bold mb-6 text-center">New News</h2>
     ...
     <div class="relative max-w-7xl md:overflow-x-hidden md:mx-auto p-4 md:px-6">
         ...
         <div
             ...
             <div class="berita-card min-w-[280px] snap-start">
                 ...
                 <!-- Teks di luar card -->
                 <div class="mt-3">
                     <a href="/detail-news" class="berita-title text-lg font-semibold mb-1">Tiltle</a>
                 </div>
             </div>
             ...
             <div class="berita-card min-w-[280px] snap-start">
                 <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                     <img src="{{ url('storage/images/berita2.jpeg') }}" alt="Berita 2"
                         class="w-full h-48 object-cover">
                 </div>
                 <div class="mt-3">
                     <a href="/detail-news" class="berita-title text-lg font-semibold mb-1">p</a>
                 </div>
             </div>
             ...
             <div class="berita-card min-w-[280px] snap-start">
                 <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                     <img src="{{ url('storage/images/berita6.webp') }}" alt="Berita 3"
                         class="w-full h-48 object-cover">
                 </div>
                 <div class="mt-3">
                     <a href="/detail-news" class="berita-title text-lg font-semibold mb-1">p</a>
