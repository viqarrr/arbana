<div>
  ...
  >
    <div class="relative flex h-full max-h-full flex-col">
      <div class="flex items-center justify-between px-6 pt-4"> <!-- Logo --> <a
        ...
        <button
          @click="open = false"
          class="size-7.5 text-gray-500 focus:outline-hidden inline-flex items-center gap-x-1 rounded-md p-1.5 text-xs disabled:pointer-events-none disabled:opacity-50"
      ...
      <div class="mt-8 h-full overflow-y-auto [&::-webkit-scrollbar]:w-0">
        ...
        >
          ...
          <div class="border-gray-200 mt-3 flex flex-col border-t pt-3 first:mt-0 first:border-t-0 first:pt-0"> 
            ...
            > Halaman </span> <!-- List -->
            <ul class="flex flex-col gap-y-1">
              <li x-data="{ homeOpen: false }">
                <button
                  @click="homeOpen = !homeOpen"
                  class="text-gray-500 hover:bg-gray-200 hover:text-gray-800 focus:outline-hidden focus:bg-gray-200 focus:text-gray-800 flex w-full items-center justify-between rounded-lg px-2.5 py-2 text-sm"
                  aria-expanded="false"
                  :aria-expanded="homeOpen.toString()"
                >
                  <span>Beranda</span>
                  <svg
                    :class="{ 'rotate-90': homeOpen }"
                ...
                <ul
                  x-show="homeOpen"
                  x-transition
                  class="text-gray-600 mt-1 flex flex-col gap-y-1 ps-4"
                  style="display: none;"
                >
                  <li> <a
                      class="text-gray-500 hover:bg-gray-200 hover:text-gray-800 focus:outline-hidden focus:bg-gray-200 focus:text-gray-800 flex w-full items-center gap-x-2 rounded-lg px-2.5 py-2 text-sm"
                  ...
                  <li> <a
                      class="text-gray-500 hover:bg-gray-200 hover:text-gray-800 focus:outline-hidden focus:bg-gray-200 focus:text-gray-800 flex w-full items-center gap-x-2 rounded-lg px-2.5 py-2 text-sm"
                      href="/admin/popular-destinations"
                    > Destinasi Populer </a> </li>
                </ul>
              </li>
