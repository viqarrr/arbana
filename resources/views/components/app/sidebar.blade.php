<div x-data="{open: false}">
  <!-- Breadcrumb -->
  <div class="sticky top-0 inset-x-0 z-20 bg-white border-y border-gray-200 px-4 -mt-px sm:px-6 lg:px-8 lg:hidden">
    <div class="flex items-center py-2">
      <!-- Navigation Toggle -->
      <button  @click.stop="open = !open" type="button" class="size-8 flex justify-center items-center gap-x-2 border border-gray-200 text-gray-800 hover:text-gray-500 rounded-lg focus:outline-hidden focus:text-gray-500 disabled:opacity-50 disabled:pointer-events-none" aria-haspopup="dialog" aria-expanded="false" aria-label="Toggle navigation">
...
<div
  ...
  class="w-65 z-60 bg-white border-gray-200 fixed inset-y-0 start-0 h-full transform border-e transition-all duration-300 lg:bottom-0 lg:end-auto lg:block lg:translate-x-0"
  role="dialog"
  tabindex="-1"
  aria-label="Sidebar"
>
  <div class="relative flex h-full max-h-full flex-col">
    <div class="flex items-center px-6 pt-4">
      <!-- Logo -->
      <a
        class="focus:outline-hidden inline-block flex-none rounded-xl text-xl font-semibold focus:opacity-80"
        href="#"
        aria-label="Preline"
      >
        <svg
    ...
    <!-- Content -->
    <div
      class="[&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 h-full overflow-y-auto [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar]:w-2"
    >
      <nav
      ...
      >
        <ul class="flex flex-col space-y-1">
          <li>
            <a
              class="bg-gray-100 text-gray-800 hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 flex items-center gap-x-3.5 rounded-lg px-2.5 py-2 text-sm"
              href="#"
            >
              <svg
          ...
          >
            <button
              type="button"
              class="hs-accordion-toggle text-gray-800 hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 flex w-full items-center gap-x-3.5 rounded-lg px-2.5 py-2 text-start text-sm"
              aria-expanded="true"
            ...
            >
              <ul
                class="hs-accordion-group space-y-1 ps-8 pt-1"
                data-hs-accordion-always-open
              >
                <li
                  class="hs-accordion"
                ...
                >
                  ...
                  >
                    <ul class="space-y-1 pt-1">
                      <li>
                        <a
                          class="text-gray-800 hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 flex items-center gap-x-3.5 rounded-lg px-2.5 py-2 text-sm"
                          href="#"
                        >
                          Link 1
                        </a>
          ...
          <li><a
              class="text-gray-800 hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 flex w-full items-center gap-x-3.5 rounded-lg px-2.5 py-2 text-sm"
              href="#"
            >
              <svg
                class="size-4 shrink-0"
