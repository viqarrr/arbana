...
<section class="mx-auto max-w-8xl pl-4 pr-0 pb-10 lg:pb-16 lg:px-26">
    <div class="flex flex-col md:justify-between md:items-center lg:justify-center w-full gap-4 pb-10 pt-20">
        <h1 class="text-3xl font-semibold">Private trip and Family Gathering</h1>
        <h1 class="text-gray-500 mt-2 text-xl font-normal">
            Discover Your Next Adventure with Our Featured Trip Deals
        </h1>
    </div>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 gap-6">
            ...
            <div class="filter-btn bg-white rounded-lg shadow hover:shadow-lg transition p-6 flex flex-col items-center text-center"
                ...
                <p class="text-sm text-neutral-500">
                    Mountain trekking priv-trips to top destinations.
                </p>
            </div>
        ...
        <div class="carousel-wrapper flex gap-6 overflow-x-auto pb-4 touch-pan-x scrollbar-hide"
            ...
            <a href="/priv-trips"
                ...
                <div class="p-4 pt-2">
                    ...
                    <span class="bg-red-100 text-red-800 rounded-full px-2.5 pb-1 pt-0.5 text-xs font-medium">Family
                        Gathering</span>
                    <h4 class="text-gray-900 mt-3 mb-1 text-lg font-bold">Mount Semeru - 3676 Mdpl</h4>
                    <p class="text-gray-500 text-sm">Lumajang</p>
            ...
            <a href="/priv-trips"
                ...
                <div class="p-4 pt-2">
                    ...
                    <span class="bg-red-100 text-red-800 rounded-full px-2.5 pb-1 pt-0.5 text-xs font-medium">Family
                        Gathering</span>
                    <h4 class="text-gray-900 mt-3 mb-1 text-lg font-bold">Mount Arjuno - 3339 Mdpl</h4>
                    <p class="text-gray-500 text-sm">Cangar, Tretes, Lawang, Purwosari</p>
                    <p class="text-gray-900 mt-1 text-2xl font-extrabold">Rp 850.000<span
                            class="text-base font-normal">/pax</span></p>
                </div>
            </a>
            ...
            <a href="/priv-trips"
                ...
                <div class="p-4 pt-2">
                    ...
                    <span class="bg-red-100 text-red-800 rounded-full px-2.5 pb-1 pt-0.5 text-xs font-medium">Family
                        Gathering</span>
                    <h4 class="text-gray-900 mt-3 mb-1 text-lg font-bold">Mount Raung - 3332 Mdpl</h4>
                    <p class="text-gray-500 text-sm">Bondowoso</p>
                    <p class="text-gray-900 mt-1 text-2xl font-extrabold">Rp 850.000<span
                            class="text-base font-normal">/pax</span></p>
                </div>
            </a>
            ...
            <a href="/priv-trips"
                ...
                <div class="p-4 pt-2">
                    ...
                    <span class="bg-red-100 text-red-800 rounded-full px-2.5 pb-1 pt-0.5 text-xs font-medium">Family
                        Gathering</span>
                    <h4 class="text-gray-900 mt-3 mb-1 text-lg font-bold">Mount Lawu - 3265 Mdpl</h4>
                    <p class="text-gray-500 text-sm">Tawangmangu</p>
                    <p class="text-gray-900 mt-1 text-2xl font-extrabold">Rp 850.000<span
                            class="text-base font-normal">/pax</span></p>
                </div>
            </a>
            ...
            <a href="/priv-trips"
                ...
                <div class="p-4 pt-2">
                    ...
                    <span class="bg-red-100 text-red-800 rounded-full px-2.5 pb-1 pt-0.5 text-xs font-medium">Family
                        Gathering</span>
                    <h4 class="text-gray-900 mt-3 mb-1 text-lg font-bold">Mount Argopuro - 3008 Mdpl</h4>
                    <p class="text-gray-500 text-sm">Probolinggo</p>
                    <p class="text-gray-900 mt-1 text-2xl font-extrabold">Rp 850.000<span
                            class="text-base font-normal">/pax</span></p>
                </div>
            </a>
            ...
            <a href="/priv-trips"
                ...
                <div class="p-4 pt-2">
                    ...
                    <span class="bg-red-100 text-red-800 rounded-full px-2.5 pb-1 pt-0.5 text-xs font-medium">Family
                        Gathering</span>
                    <h4 class="text-gray-900 mt-3 mb-1 text-lg font-bold">Mount Ijen - 2799 Mdpl</h4>
                    <p class="text-gray-500 text-sm">Bondowoso</p>
                    <p class="text-gray-900 mt-1 text-2xl font-extrabold">Rp 850.000<span
                            class="text-base font-normal">/pax</span></p>
                </div>
            ...
            <a href="/priv-trips"
                ...
                <div class="p-4 pt-2">
                    ...
                    <span class="bg-red-100 text-red-800 rounded-full px-2.5 pb-1 pt-0.5 text-xs font-medium">Family
                        Gathering</span>
                    <h4 class="text-gray-900 mt-3 mb-1 text-lg font-bold">Mount Buthak - 2868 Mdpl</h4>
                    <p class="text-gray-500 text-sm">Batu</p>
                    <p class="text-gray-900 mt-1 text-2xl font-extrabold">Rp 850.000<span
                            class="text-base font-normal">/pax</span></p>
                </div>
            </a>
            ...
            <a href="/priv-trips"
                ...
                <div class="p-4 pt-2">
                    ...
                    <span class="bg-red-100 text-red-800 rounded-full px-2.5 pb-1 pt-0.5 text-xs font-medium">Family
                        Gathering</span>
                    <h4 class="text-gray-900 mt-3 mb-1 text-lg font-bold">Mount Kelud - 1731 Mdpl</h4>
                    <p class="text-gray-500 text-sm">Malang, Kediri, Blitar</p>
                    <p class="text-gray-900 mt-1 text-2xl font-extrabold">Rp 850.000<span
                            class="text-base font-normal">/pax</span></p>
                </div>
            </a>
            ...
            <div class="trip-card bg-white rounded-xl shadow-lg h-80 min-w-[280px] snap-start shrink-0 hover:shadow-xl overflow-hidden"
                ...
                <div class="p-4 pt-2">
                    ...
                    <span class="bg-red-100 text-red-800 rounded-full px-2.5 pb-1 pt-0.5 text-xs font-medium">Family
                        Gathering</span>
                    <h4 class="text-gray-900 mt-3 mb-1 text-lg font-bold">Mount Penanggungan - 1635 Mdpl</h4>
            ...
            <a href="/priv-trips"
                class="trip-card bg-white rounded-xl shadow-lg h-80 min-w-[280px] snap-start shrink-0 overflow-hidden"
                data-category="gunung">
                <img src="{{ url('storage/images/panderman.jpg') }}" class="h-40 w-full object-cover" />
                <div class="p-4 pt-2">
                    <span class="bg-blue-100 text-blue-800 rounded-full px-2.5 pb-1 pt-0.5 text-xs font-medium">Private
                        Trip</span>
                    <span class="bg-red-100 text-red-800 rounded-full px-2.5 pb-1 pt-0.5 text-xs font-medium">Family
                        Gathering</span>
                    <h4 class="text-gray-900 mt-3 mb-1 text-lg font-bold">Mount Panderman - 2045 Mdpl</h4>
                    <p class="text-gray-500 text-sm">Batu</p>
                    <p class="text-gray-900 mt-1 text-2xl font-extrabold">Rp 850.000<span
                            class="text-base font-normal">/pax</span></p>
                </div>
            ...
            <a href="/priv-trips"
                ...
                <div class="p-4 pt-2">
                    ...
                    <span class="bg-red-100 text-red-800 rounded-full px-2.5 pb-1 pt-0.5 text-xs font-medium">Family
                        Gathering</span>
                    <h4 class="text-gray-900 mt-3 mb-1 text-lg font-bold">Mount Kawi - 2603 Mdpl</h4>
            ...
            <a href="/priv-trips"
                ...
                <div class="p-4 pt-2">
                    ...
                    <span class="bg-red-100 text-red-800 rounded-full px-2.5 pb-1 pt-0.5 text-xs font-medium">Family
                        Gathering</span>
                    <h4 class="text-gray-900 mt-3 mb-1 text-lg font-bold">MT Lorokan - 1100 Mdpl</h4>
                    <p class="text-gray-500 text-sm">Mojokerto</p>
                    <p class="text-gray-900 mt-1 text-2xl font-extrabold">Rp 850.000<span
                            class="text-base font-normal">/pax</span></p>
                </div>
            ...
            <a href="/priv-trips"
                class="trip-card bg-white rounded-xl shadow-lg h-80 min-w-[280px] snap-start shrink-0 overflow-hidden"
                data-category="anak-gunung">
                <img src="{{ url('storage/images/cendono.jpg') }}" class="h-40 w-full object-cover" />
                <div class="p-4 pt-2">
                    <span class="bg-blue-100 text-blue-800 rounded-full px-2.5 pb-1 pt-0.5 text-xs font-medium">Private
                        Trip</span>
                    <span class="bg-red-100 text-red-800 rounded-full px-2.5 pb-1 pt-0.5 text-xs font-medium">Family
                        Gathering</span>
                    <h4 class="text-gray-900 mt-3 mb-1 text-lg font-bold">MT Cendono - 1131 Mdpl</h4>
                    <p class="text-gray-500 text-sm">Mojokerto</p>
                    <p class="text-gray-900 mt-1 text-2xl font-extrabold">Rp 850.000<span
                            class="text-base font-normal">/pax</span></p>
                </div>
            ...
            <a href="/priv-trips"
                class="trip-card bg-white rounded-xl shadow-lg h-80 min-w-[280px] snap-start shrink-0 overflow-hidden"
                data-category="anak-gunung">
                <img src="{{ url('storage/images/jengger.webp') }}" class="h-40 w-full object-cover" />
                <div class="p-4 pt-2">
                    <span class="bg-blue-100 text-blue-800 rounded-full px-2.5 pb-1 pt-0.5 text-xs font-medium">Private
                        Trip</span>
                    <span class="bg-red-100 text-red-800 rounded-full px-2.5 pb-1 pt-0.5 text-xs font-medium">Family
                        Gathering</span>
                    <h4 class="text-gray-900 mt-3 mb-1 text-lg font-bold">MT Watu Jengger - 1100 Mdpl</h4>
                    <p class="text-gray-500 text-sm">Mojokerto</p>
                    <p class="text-gray-900 mt-1 text-2xl font-extrabold">Rp 850.000<span
                            class="text-base font-normal">/pax</span></p>
                </div>
            ...
            <a href="/priv-trips"
                ...
                <div class="p-4 pt-2">
                    ...
                    <span class="bg-red-100 text-red-800 rounded-full px-2.5 pb-1 pt-0.5 text-xs font-medium">Family
                        Gathering</span>
                    <h4 class="text-gray-900 mt-3 mb-1 text-lg font-bold">MT Rengganis / Janda</h4>
                    <p class="text-gray-500 text-sm">Mojokerto</p>
                    <p class="text-gray-900 mt-1 text-2xl font-extrabold">Rp 850.000<span
                            class="text-base font-normal">/pax</span></p>
                </div>
            ...
            <a href="/priv-trips"
                ...
                <img src="{{ url('storage/images/3warna.jpg') }}" class="h-40 w-full object-cover" />
                <div class="p-4 pt-2">
                    <span class="bg-blue-100 text-blue-800 rounded-full px-2.5 pb-1 pt-0.5 text-xs font-medium">Private
                        Trip</span>
                    <span class="bg-red-100 text-red-800 rounded-full px-2.5 pb-1 pt-0.5 text-xs font-medium">Family
                        Gathering</span>
                    <h4 class="text-gray-900 mt-3 mb-1 text-lg font-bold">Tiga Warna Beach</h4>
                    <p class="text-gray-500 text-sm">Malang</p>
                    <p class="text-gray-900 mt-1 text-2xl font-extrabold">Rp 850.000<span
                            class="text-base font-normal">/pax</span></p>
                </div>
            ...
            <a href="/priv-trips"
                class="trip-card bg-white rounded-xl shadow-lg h-80 min-w-[280px] snap-start shrink-0 overflow-hidden"
                data-category="pantai">
                <img src="{{ url('storage/images/balekambang.jpg') }}" class="h-40 w-full object-cover" />
                <div class="p-4 pt-2">
                    <span class="bg-blue-100 text-blue-800 rounded-full px-2.5 pb-1 pt-0.5 text-xs font-medium">Private
                        Trip</span>
                    <span class="bg-red-100 text-red-800 rounded-full px-2.5 pb-1 pt-0.5 text-xs font-medium">Family
            ...
            <a href="/priv-trips"
                class="trip-card bg-white rounded-xl shadow-lg h-80 min-w-[280px] snap-start shrink-0 overflow-hidden"
                data-category="pantai">
                <img src="{{ url('storage/images/banyumeneng.jpg') }}" class="h-40 w-full object-cover" />
                <div class="p-4 pt-2">
                    <span class="bg-blue-100 text-blue-800 rounded-full px-2.5 pb-1 pt-0.5 text-xs font-medium">Private
                        Trip</span>
                    <span class="bg-red-100 text-red-800 rounded-full px-2.5 pb-1 pt-0.5 text-xs font-medium">Family
                        Gathering</span>
                    <h4 class="text-gray-900 mt-3 mb-1 text-lg font-bold">Banyu Meneng Beach</h4>
                    <p class="text-gray-500 text-sm">Malang</p>
                    <p class="text-gray-900 mt-1 text-2xl font-extrabold">Rp 850.000<span
                            class="text-base font-normal">/pax</span></p>
                </div>
            ...
            <a href="/priv-trips"
                class="trip-card bg-white rounded-xl shadow-lg h-80 min-w-[280px] snap-start shrink-0 overflow-hidden"
                data-category="pantai">
                <img src="{{ url('storage/images/tanjungpenyu.jpg') }}" class="h-40 w-full object-cover" />
                <div class="p-4 pt-2">
                    <span class="bg-blue-100 text-blue-800 rounded-full px-2.5 pb-1 pt-0.5 text-xs font-medium">Private
                        Trip</span>
                    <span class="bg-red-100 text-red-800 rounded-full px-2.5 pb-1 pt-0.5 text-xs font-medium">Family
                        Gathering</span>
                    <h4 class="text-gray-900 mt-3 mb-1 text-lg font-bold">Tanjung Penyu Beach</h4>
                    <p class="text-gray-500 text-sm">Malang</p>
                    <p class="text-gray-900 mt-1 text-2xl font-extrabold">Rp 850.000<span
                            class="text-base font-normal">/pax</span></p>
                </div>
            ...
            <a href="/priv-trips"
                class="trip-card bg-white rounded-xl shadow-lg h-80 min-w-[280px] snap-start shrink-0 overflow-hidden"
                data-category="pantai">
                <img src="{{ url('storage/images/telukasmara.jpg') }}" class="h-40 w-full object-cover" />
                <div class="p-4 pt-2">
                    <span class="bg-blue-100 text-blue-800 rounded-full px-2.5 pb-1 pt-0.5 text-xs font-medium">Private
                        Trip</span>
                    <span class="bg-red-100 text-red-800 rounded-full px-2.5 pb-1 pt-0.5 text-xs font-medium">Family
                        Gathering</span>
                    <h4 class="text-gray-900 mt-3 mb-1 text-lg font-bold">Teluk Asmara Beach</h4>
                    <p class="text-gray-500 text-sm">Malang</p>
                    <p class="text-gray-900 mt-1 text-2xl font-extrabold">Rp 850.000<span
                            class="text-base font-normal">/pax</span></p>
                </div>
            ...
            <a href="/priv-trips"
                class="trip-card bg-white rounded-xl shadow-lg h-80 min-w-[280px] snap-start shrink-0 overflow-hidden"
                data-category="pantai">
                <img src="{{ url('storage/images/jonggring.webp') }}" class="h-40 w-full object-cover" />
                <div class="p-4 pt-2">
                    <span class="bg-blue-100 text-blue-800 rounded-full px-2.5 pb-1 pt-0.5 text-xs font-medium">Private
                        Trip</span>
                    <span class="bg-red-100 text-red-800 rounded-full px-2.5 pb-1 pt-0.5 text-xs font-medium">Family
                        Gathering</span>
                    <h4 class="text-gray-900 mt-3 mb-1 text-lg font-bold">Jonggring Beach</h4>
                    <p class="text-gray-500 text-sm">Malang</p>
                    <p class="text-gray-900 mt-1 text-2xl font-extrabold">Rp 850.000<span
                            class="text-base font-normal">/pax</span></p>
                </div>
