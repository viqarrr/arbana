        ...
        <div class="flex flex-1 flex-col lg:flex-row">
            <div class="border-gray-200 flex min-w-0 flex-1 flex-col border-e">
                <div class="bg-white border-gray-200 flex flex-col p-4">
                    ...
                    <!-- Header -->
                    <div
                        class="border-gray-200 flex flex-wrap items-center justify-between gap-2 border-b border-dashed pb-2">
                        <div class="relative">
                        ...
                        <button @click="$dispatch('open-modal', 'create-product')" type="button"
                    ...
                    <div class="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                        @foreach ($products as $product)
                            ...
                            <!-- Edit Modal -->
                            <x-app.modal name="edit-product-{{ $product->id }}" title="Edit Produk" max-width="3xl">
                                    ...
                                    <div class="space-y-4">
                                        <div class="grid grid-cols-2 gap-4">
                                            <div class="col-span-2">
                                                <label class="text-gray-700 mb-2 block text-sm font-medium">Nama Produk
                                                    *</label>
                                            ...
                                            <div class="col-span-2">
                                                ...
                                                <textarea name="description" rows="3"
                                                    class="border-gray-300 focus:border-blue-500 w-full rounded-lg border px-4 py-2.5 text-sm" required>{{ $product->description }}</textarea>
                                            </div>

                                            <div>
                                                <label class="text-gray-700 mb-2 block text-sm font-medium">Stok
                                                    *</label>
                                            ...
                                            <div>
                                                <label class="text-gray-700 mb-2 block text-sm font-medium">Harga 1 Hari
                                                    *</label>
                                                <input type="number" name="price_one_day"
                                                    value="{{ $product->price_one_day }}" min="0"
                                                    class="border-gray-300 focus:border-blue-500 w-full rounded-lg border px-4 py-2.5 text-sm"
                                                    required>
                                            </div>

                                            <div>
                                                <label class="text-gray-700 mb-2 block text-sm font-medium">Harga 2 Hari
                                                    *</label>
                                                <input type="number" name="price_two_days"
                                                    value="{{ $product->price_two_days }}" min="0"
                                                    class="border-gray-300 focus:border-blue-500 w-full rounded-lg border px-4 py-2.5 text-sm"
                                                    required>
                                            </div>

                                            <div>
                                                <label class="text-gray-700 mb-2 block text-sm font-medium">Harga
                                                    Extra/Hari *</label>
                                                <input type="number" name="price_extra_per_day"
                                                    value="{{ $product->price_extra_per_day }}" min="0"
                                                    class="border-gray-300 focus:border-blue-500 w-full rounded-lg border px-4 py-2.5 text-sm"
                                                    required>
                                            </div>
                                        </div>
                    ...
                    <!-- Create Modal -->
                    <x-app.modal name="create-product" title="Tambah Produk" max-width="3xl">
                        <form action="{{ route('admin.products.store') }}" method="POST"
                            ...
                            <div class="space-y-4">
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <div class="col-span-2">
                                        ...
                                        <textarea name="description" rows="3"
                                            class="border-gray-300 focus:border-blue-500 w-full rounded-lg border px-4 py-2.5 text-sm" required>{{ old('description') }}</textarea>
                                    </div>
                                    ...
                                    <div>
                                        <label class="text-gray-700 mb-2 block text-sm font-medium">Harga 2 Hari
                                            *</label>
                                        <input type="number" name="price_two_days"
                                            value="{{ old('price_two_days') }}" min="0"
                                            class="border-gray-300 focus:border-blue-500 w-full rounded-lg border px-4 py-2.5 text-sm"
                                            required>
                                    </div>

                                    <div>
                                        <label class="text-gray-700 mb-2 block text-sm font-medium">Harga Extra/Hari
                                            *</label>
                                        <input type="number" name="price_extra_per_day"
                                            value="{{ old('price_extra_per_day') }}" min="0"
                                            class="border-gray-300 focus:border-blue-500 w-full rounded-lg border px-4 py-2.5 text-sm"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <label class="text-gray-700 mb-2 block text-sm font-medium">Gambar Produk *</label>
                                    <input type="file" name="image" accept="image/*" x-ref="fileInput"
                                        @change="handleFile($event)"
                                        class="border-gray-200 file:bg-blue-600 file:text-white hover:file:bg-blue-700 focus:border-blue-500 focus:ring-blue-200 w-full cursor-pointer rounded-lg border px-4 py-0.5 text-sm transition file:mr-4 file:rounded-md file:border-0 file:px-4 file:py-2 file:text-sm file:font-medium focus:ring"
                                        required>
                                    <p class="text-gray-500 mt-1 text-xs">Masukkan gambar untuk produk.
                                    </p>
                                    <x-input-error for="image" class="mt-2"></x-input-error>
                            ...
                            <div class="mt-6 flex justify-end space-x-3">
                                <button type="button" @click="$dispatch('close-modal', 'create-product')"
                                    class="border-gray-300 bg-white text-gray-700 rounded-lg border px-4 py-2 text-sm">Batal</button>
