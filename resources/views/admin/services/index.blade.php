      ...
      <div class="border-gray-200 flex min-w-0 flex-1 flex-col border-e">
        <div class="bg-white border-gray-200 flex flex-col p-4">
          ...
          <div
            ...
            <button
              @click="$dispatch('open-modal', 'create-service')"
              type="button"
            ...
            @foreach ($services as $service)
              <div class="bg-white border-gray-200 overflow-hidden rounded-lg border transition hover:shadow-lg">
                ...
                <div class="p-5">
                  ...
                  <p class="text-gray-600 mb-4 line-clamp-2 text-sm">{{ $service->description }}</p>

                  <div class="bg-blue-50 mb-4 rounded-lg p-3">
                    <p class="text-gray-600 mb-1 text-xs">Harga Layanan</p>
                    <p class="text-blue-600 text-2xl font-bold">Rp {{ number_format($service->price, 0, ',', '.') }}</p>
                  </div>

                  <div class="flex gap-2">
                    <button
                      @click="$dispatch('open-modal', 'edit-service-{{ $service->id }}')"
                      type="button"
          ...
          >
            ...
            >
              ...
              <div class="mt-6 flex justify-end space-x-3">
                <button
                  type="button"
                  @click="$dispatch('close-modal', 'create-service')"
                  class="border-gray-300 bg-white text-gray-700 rounded-lg border px-4 py-2 text-sm"
                >Batal</button>
                <button
                  type="submit"
