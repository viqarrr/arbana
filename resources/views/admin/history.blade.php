<x-app-layout>
  <x-slot name="header">{{ __('Tentang Kami - Sejarah') }}</x-slot>
    ...
    <div class="flex flex-1 flex-col lg:flex-row">
      <div class="flex min-w-0 flex-1 flex-col">
        <div class="bg-white flex flex-col p-4">
              ...
              <div class="flex flex-col gap-5 pt-4 md:flex-row">
                <div class="aspect-4/2 md:aspect-4/3 bg-gray-100 relative w-full rounded-lg md:max-w-80">
                  ...
                  <img
                    ...
                    src="{{ asset('storage/' . $aboutHistory->image) }}"
                    alt="Post Image">
                  @endif
                </div>
                  ...
                  <div class="flex h-full flex-col">
                    ...
                    <div class="border-gray-200 mt-4 border-t pt-4 xl:mt-auto">
                      <div class="flex flex-wrap items-center justify-end gap-2">
                        <button
                          type="button"
                          @click="$dispatch('open-modal', 'edit-about-history')"
          ...
          <!-- Edit Modal -->
          <x-app.modal
            name="edit-about-history"
            title="Edit Sejarah Perusahaan"
            max-width="4xl">
            <form
              action="{{ route('admin.history.update', $aboutHistory) }}"
              ...
              <div class="space-y-6">
                ...
                <div>
                  ...
                  <div
                    ...
                    <div x-ref="quillEditor" class="min-h-40">{!! $aboutHistory->paragraph !!}</div>
                    <input
                      type="hidden"
                      name="paragraph"
                      x-ref="hiddenContent"
                      value="{{ $aboutHistory->paragraph }}">
                  </div>
                  <x-input-error
                    for="paragraph"
                    class="mt-2"></x-input-error>
              ...
              <div class="mt-6 flex justify-end space-x-3">
                <button
                  type="button"
                  @click="$dispatch('close-modal', 'edit-about-history')"
