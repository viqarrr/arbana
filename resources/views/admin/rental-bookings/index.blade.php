                  ...
                  <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <div class="flex-1">
                      <div class="mb-3 flex items-start justify-between">
                        <div>
                          <div class="mb-2 flex items-center space-x-3">
                            <span class="text-gray-500 text-sm font-medium">Rental #{{ $booking->id }}</span>
                          ...
                          <h3 class="text-gray-900 mb-1 text-lg font-semibold">{{ $booking->equipment->name }}</h3>
                          <p class="text-gray-600 text-sm">{{ $booking->equipment->description }}</p>
                        </div>
                      </div>
                      ...
                      <div class="grid grid-cols-2 gap-4 md:grid-cols-5">
                        ...
                        <div>
                          <p class="text-gray-500 mb-1 text-xs">Quantity</p>
                          <p class="text-gray-900 text-sm font-medium">{{ $booking->quantity }} units</p>
                        </div>
                        <div>
                          <p class="text-gray-500 mb-1 text-xs">Rental Period</p>
                          <p class="text-gray-900 text-sm font-medium">{{ $booking->total_days }} days</p>
                          <p class="text-gray-600 text-xs">
                            {{ $booking->start_date->format('M j') }} - {{ $booking->end_date->format('M j, Y') }}
                          </p>
                        </div>
                        <div>
                          <p class="text-gray-500 mb-1 text-xs">Created</p>
                          <p class="text-gray-900 text-sm font-medium">{{ $booking->created_at->format('M j, Y') }}</p>
                        </div>
                        <div>
