    ...
    <div class="flex flex-1 flex-col lg:flex-row">
      <div class="flex min-w-0 flex-1 flex-col">
        <div class="bg-white flex flex-col p-4">
              ...
              <div class="flex flex-col gap-5 pt-4 md:flex-row">
                <div class="aspect-4/2 md:aspect-4/3 bg-gray-100 relative w-full rounded-lg md:max-w-80">
                  <img
                    ...
                    src="{{ asset('storage/' . $aboutExcellence->image) }}"
                    alt="Post Image"
                  >
                </div>
          ...
          <!-- Edit Modal -->
          <x-app.modal
            name="edit-about-excellence"
            title="Edit Sejarah Perusahaan"
            max-width="4xl"
          >
            <form
              action="{{ route('admin.history.update', $aboutExcellence) }}"
            ...
            >
              ...
              <div class="space-y-6">
                ...
                <div>
                  ...
                  >
                    <div x-ref="quillEditor" class="min-h-40">{!! $aboutExcellence->paragraph !!}</div>
                    <input
                      type="hidden"
                      name="paragraph"
                      x-ref="hiddenContent"
                      value="{{ $aboutExcellence->paragraph }}"
                    >
                  </div>
                  <x-input-error
                    for="paragraph"
              ...
              <div class="mt-6 flex justify-end space-x-3">
                <button
                  type="button"
                  @click="$dispatch('close-modal', 'edit-about-excellence')"
